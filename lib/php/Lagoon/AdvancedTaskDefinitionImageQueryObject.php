...
class AdvancedTaskDefinitionImageQueryObject extends QueryObject
{
    const OBJECT_NAME = "AdvancedTaskDefinitionImage";
    ...
    public function selectAdvancedTaskDefinitionArguments(AdvancedTaskDefinitionImageAdvancedTaskDefinitionArgumentsArgumentsObject $argsObject = null)
    {
